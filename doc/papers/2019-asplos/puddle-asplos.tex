...
\title{\mytitle}
\subtitle{Preprint draft, last edited \today}
...
\mw[inline]{make this longer, describe the semantics, add multi droplet flush}
...
The \codeinline{flush} operation allows the user to manually force all pending operations to complete, which is useful in interactive programming.
...
\camera[inline]{This section has been overhauled, further highlighting the drawbacks of the purely dynamic approach.}
...
\begin{acks}
  ...
  This work is supported by some grants \todo{grant numbers}.
\end{acks}
