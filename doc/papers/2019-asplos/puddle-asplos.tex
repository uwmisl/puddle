...
The user then calls \codeinline{mix_n_heat} with the a list containing the three droplet ids as an argument.
Note that \codeinline{mix_n_heat} is regular Python function and thus completely transparent to the Puddle system; it could be recursive, exported or imported from a library, or passed around as a first-class value.
...
The left snippet demonstrates a bad argument by trying to \codeinline{input} too small a volume of fluid; the pumps do not have that level of precision.
